...
void Beep2();
void BeepUp(uint16_t Period, uint16_t step, uint16_t Beeplength, uint16_t Delaylength);
void BeepDown(uint16_t Period, uint16_t step, uint16_t Beeplength, uint16_t Delaylength);
